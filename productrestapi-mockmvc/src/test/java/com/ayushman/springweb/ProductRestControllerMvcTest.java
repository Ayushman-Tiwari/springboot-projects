...
public class ProductRestControllerMvcTest {
	...
	private static final String PRODUCT_DESCRIPTION = "entry level Macbook";

	private static final String PRODUCT_NAME = "Macbook Air";
	...
	public void testFindProduct() throws Exception {
		...
		when(repository.findById(PRODUCT_ID)).thenReturn(result);
